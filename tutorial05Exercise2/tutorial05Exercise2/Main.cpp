...
void RenderFrame(void)
{
	...
	//totate 45 degree around x axis , need to convert to radians
	...
	world = XMMatrixRotationX(XMConvertToRadians(rotationValue));  // the rotation degree
	world *= XMMatrixTranslation(0, 0, 15);    // the place of the triangle
